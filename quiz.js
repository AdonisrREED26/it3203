...
// Safe selector for the quiz form
const quizForm = document.getElementById('matrixQuizEngine');

if (quizForm) {
    quizForm.addEventListener('submit', function(matrixEvent) {
...
// Safe selector for the wipe button
const wipeBtn = document.getElementById('engineWipe');
